        ...
        <div class="mySlides">
            ...
            <div class="d-flex justify-content-center">
                @foreach($cliente as $item)
                    <a href="{{asset('/documentos/clientes/'.$itemDocumentos->nombre)}}" target="_blank">Ver completa</a>
                    <hr>
                    <a href="{{asset('/documentos/clientes/'.$itemDocumentos->nombre)}}" download="Documento-{{$itemDocumentos->nombres}}-{{$itemDocumentos->apellidos}}-{{$itemDocumentos->nombre}}" >Descargar Documento </a>
                @endforeach
            </div>
        </div>
    @endforeach
