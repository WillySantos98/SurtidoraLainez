...
<div class="container-fluid">
    ...
    <h4 class="text-center">Ingreso de Placas</h4>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card border-left-warning">
                                    ...
                                    <input id="FormularioPlacas-NumeroBoleta" type="text" maxlength="7" class="form-control @error('NumeroBoleta') is-invalid @enderror" name="NumeroBoleta">
                                </div>
                                @error('NumeroBoleta')
                            ...
                            <div class="col" >
                                <div class="card border-left-warning" >
                                    ...
                                    <input id="FormularioPlacas-Comprobante" maxlength="11" type="text" class="form-control @error('Comprobante') is-invalid @enderror" name="Comprobante">
                                </div>
                                @error('Comprobante')
                                <div class="alert alert-danger">{{$message}}</div>
                                @enderror
                            ...
                            <div class="col">
                                <div class="card border-left-warning">
                                    ...
                                    <input type="date" class="form-control @error('FechaVencimiento') is-invalid @enderror" name="FechaVencimiento" id="FormularioPlacas-FechaVencimiento">
                                </div>
                            ...
                            <div class="col">
                                <div class="card border-left-warning">
                                    ...
                                    <input type="text" class="form-control @error('Placa') is-invalid @enderror" name="Placa" maxlength="7" id="FormularioPlacas-Placa">
                                </div>
                                @error('Placa')
                                <div class="alert alert-danger">{{$message}}</div>
                                @enderror
                        ...
                        <div class="row" style="margin-top: 10px">
                            <div class="col">
                                <div class="card border-left-warning">
                                    ...
                                    <input type="text" maxlength="14" class="form-control @error('Identificacion') is-invalid @enderror" name="Identificacion" id="FormularioPlacas-Identificacion">
                                </div>
                            ...
                            <div class="col">
                                <div class="card border-left-warning">
                                    ...
                                    <input type="text" class="form-control @error('Propietario') is-invalid @enderror" name="Propietario" id="FormularioPlacas-Propietario">
                                </div>
                                @error('Propietario')
                                <div class="alert alert-danger">{{$message}}</div>
                                @enderror
                            ...
                            <div class="col-sm-2">
                                <div class="card border-left-warning">
                                    ...
                                    <input type="number" maxlength="4" class="form-control @error('Año') is-invalid @enderror" name="Año" id="FormularioPlacas-Ano" >
                                </div>
                                @error('Año')
                                <div class="alert alert-danger">{{$message}}</div>
                                @enderror
