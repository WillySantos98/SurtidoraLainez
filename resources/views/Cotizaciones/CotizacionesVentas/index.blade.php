...
@section('content')
    ...
    <div class="card border-left-primary">
        <div class="row" style="padding: 5px">
            ...
            <div class="col"><h4>Cotizaciones De Ventas Pendientes</h4></div>
                ...
                <table class="table table-responsive-lg table-sm table-hover" style="font-size: 13px">
                    ...
                    @foreach($cotizaciones as $cotizacion)
                        <tr>
                            ...
                            <td><a href="/documentos/cotizaciones/cotizaciones_ventas_pendientes/{{$cotizacion->cod_cotizacion}}">Ver Cotizacion</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
