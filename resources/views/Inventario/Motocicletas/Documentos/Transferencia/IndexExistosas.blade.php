@extends('Index.base')
@section('title', 'Transferencias Exitosas')
@section('content')
    @include('Inventario.Motocicletas.Documentos.encabezado')
    <hr>
    <h4 class="text-center">Transferencias Exitosas entre Tienda</h4>
        ...
        <table class="table table-sm">
            ...
            @foreach($transferencia as $info)
                <tr>
                    ...
                    @if($info->estado_c == 1)
                        <td><span class="badge badge-success">Transferencia Exitosa</span></td>
                    @endif
